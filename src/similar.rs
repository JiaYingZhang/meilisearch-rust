...
/// #  .unwrap();
///
/// let mut res = SimilarQuery::new(&index)
///     .with_id(100)
...
//         let mut query = SimilarQuery::new(&index);
//         query
//             .with_embedder("default")
//             .with_offset(42)
//             .with_limit(21);
...
//         let mut query = SimilarQuery::new(&index);
//         query.with_embedder("default").with_limit(5);
...
//         setup_test_vector_index(&client, &index).await?;
//         let mut query = SimilarQuery::new(&index);
//         query.with_embedder("default").with_offset(6);
